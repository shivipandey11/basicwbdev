...
<hr>
    ...
    &nbsp &nbsp&nbsp &nbsp
    <a href="category1.php"> <img src="images/01.jpg" onmouseover="this.src='images/Picture2.png'" onmouseout="this.src='images/01.jpg'" width="300px" height="180px"> </a>
    <a href="category2.php"> <img src="images/02.jpg" onmouseover="this.src='images/Picture3.png'" onmouseout="this.src='images/02.jpg'" width="300px" height="180px"> </a>
    <a href="category3.php"> <img src="images/03.jpg" onmouseover="this.src='images/Picture4.png'" onmouseout="this.src='images/03.jpg'" width="300px" height="180px"> </a>
	<a href="category4.php"> <img src="images/04.jpg" onmouseover="this.src='images/Picture5.png'" onmouseout="this.src='images/04.jpg'"width="300px" height="180px"> </a>
	<br>&nbsp &nbsp&nbsp &nbsp
    <a href="category5.php"> <img src="images/05.jpg" onmouseover="this.src='images/Picture6.png'" onmouseout="this.src='images/05.jpg'"width="300px" height="180px"> </a>
	<a href="category6.php"> <img src="images/06.jpg" onmouseover="this.src='images/Picture7.png'" onmouseout="this.src='images/06.jpg'"width="300px" height="180px"> </a>
	<a href="category7.php"> <img src="images/07.jpg" onmouseover="this.src='images/Picture8.png'" onmouseout="this.src='images/07.jpg'"width="300px" height="180px">  </a>
